...
class CryptoFE():
    ...
    def Dec(self, pp, y, ask, cti):
        ...
        print("TEST")
        # type(),
        print("N",type(pp["N"]),pp["N"])
        print("N2",type(pp["N2"]), pp["N2"])
        print("testRN")
        testRN = self.groupR.random(pp["N"])
        print(type(testRN),testRN)
        print(type(testRN), integer(testRN) * 2)
        testRN = self.groupR.random(pp["N"])
        testRI = random.randint(-500000000000000, 500000000000000)
        print("TEST")
        # type(),
        print("N",type(pp["N"]),pp["N"])
        print("N2",type(pp["N2"]), pp["N2"])
        print("testRN")
        print(type(testRN),testRN)
        print(type(int(testRN)),int(testRN))
        print(type(integer(testRN)),integer(testRN))
        
        print(type(testRN % pp["N"]),testRN % pp["N"])
        print(type(testRN % pp["N"]),testRN % (pp["N"] + 1))
        print(type(testRN % pp["N"]),(testRN % (pp["N"] + 1)) % (pp["N"] + 2))
        print(type(testRN % pp["N2"]),testRN % pp["N2"])
        
        print("testRI")
        print(type(testRI),testRI)
        print(type(int(testRI)),int(testRI))
        print(type(integer(testRI)),integer(testRI))
        
        print(type(testRI % 123), testRI % 123)
        print(type(testRI % pp["N"]), testRI % pp["N"])
        print(type(testRI % pp["N2"]), testRI % pp["N2"])
        '''